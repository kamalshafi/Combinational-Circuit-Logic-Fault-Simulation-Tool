...
typedef struct GATE_type
{
  ...
  int Type,Nfi,Nfo,Mark,Val,Po,Fval;     //Type, No of fanins, No of fanouts, Marker,Value
...
//4. structure declaration for faults
...
/***************************************************************************************************************************
Functions in declared in input.cxxxxxxxxxxxxxxxxxxx000001111xxxxxxxxxxxxxxxxxxxxxxxxxxxx0xxxx11110000111xxx0xxxxxxxxx1xxxxxxxxxxxxxxxxxxxxx1
****************************************************************************************************************************/
/***************************************************************************************************************************
...
void faultsim(GATE *, PATTERN *,FAULT *, int , int ,int , FILE *);
void Gout(GATE *, int); 
